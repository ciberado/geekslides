...
import { parseConfig, buildColorVars } from '../../src/plugins/builtins/css-doodle-processor.ts';
import type { ParsedDoodleConfig } from '../../src/plugins/builtins/css-doodle-patterns/types.ts';
